...
!-----------------------------------------------------------------------
!> INTERPOLATE THE SOLUTION ARRAY TO THE BOUNDARY USING LAGRANGE
!! INTERPOLATING POLYNOMIAL. (USE BLAS VECTOR DOT FUNCTION)
!-----------------------------------------------------------------------
SUBROUTINE INTERPOLATE_TO_BOUNDARY_BLAS(N, Q, LAG, INTER)
    ...
    DOUBLE PRECISION :: DDOT ! BLAS VECTOR DOT FUNCTION
    
    INTER = 0.0D0
    
    INTER = DDOT(N+1, LAG, 1, Q, 1)

END SUBROUTINE INTERPOLATE_TO_BOUNDARY_BLAS
