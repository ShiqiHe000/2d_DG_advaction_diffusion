...
DOUBLE PRECISION :: DELTA_X !< ELEMENT SIZE IN X DIRECTION
DOUBLE PRECISION :: DELTA_Y !< ELEMENT SIZE IN Y DIRECTION
...
SUBROUTINE GET_NODAL_2D_STORAGE_BASIS
!-----------------------------------------------------------------------
! ALGORITHM 63
...
SUBROUTINE GET_NODAL_2D_STORAGE_EXTENDS
!-----------------------------------------------------------------------
! ALGORITHM 89
