...
DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:, :) :: FLUX_X !< NUMERICAL FLUX 
DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:, :) :: FLUX_Y !< NUMERICAL FLUX 
!DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:) :: VELOCITY_U   !< VELOCITY IN X DIRECTION
!DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:) :: VELOCITY_V   !< VELOCITY IN Y DIRECTION
