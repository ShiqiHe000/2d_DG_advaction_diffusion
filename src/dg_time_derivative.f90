...
!        CALL RIEMANN(SOLUTION_EXT_L, SOLUTION_INT_L, NFLUX_X_L, K_X, K_Y, (/-1.0D0, 0.0D0/))
!        CALL RIEMANN(SOLUTION_INT_R, SOLUTION_EXT_R, NFLUX_X_R, K_X, K_Y, (/1.0D0, 0.0D0/))
        
!        CALL RIEMANN(SOLUTION_EXT_L, SOLUTION_INT_L, NFLUX_X_L, 1.0D0, 1.0D0, (/-1.0D0, 0.0D0/))
!        CALL RIEMANN(SOLUTION_INT_R, SOLUTION_EXT_R, NFLUX_X_R, 1.0D0, 1.0D0, (/1.0D0, 0.0D0/))
...
!!        CALL LAX_FRIEDRICHES_FLUX(SOLUTION_EXT_L, SOLUTION_INT_L,&
!!                                    NFLUX_Y_D, 0.0D0, -1.0D0)
                                    
!!        CALL LAX_FRIEDRICHES_FLUX(SOLUTION_INT_R, SOLUTION_EXT_R,&
!!                                    NFLUX_Y_U, 0.0D0,  1.0D0)
                                    
!!        CALL RIEMANN(SOLUTION_EXT_L, SOLUTION_INT_L, NFLUX_Y_D, K_X, K_Y, (/0.0D0, -1.0D0/))
!!        CALL RIEMANN(SOLUTION_INT_R, SOLUTION_EXT_R, NFLUX_Y_U, K_X, K_Y, (/0.0D0, 1.0D0/))
        
!        CALL RIEMANN(SOLUTION_EXT_L, SOLUTION_INT_L, NFLUX_Y_D, 1.0D0, 1.0D0, (/0.0D0, -1.0D0/))
!        CALL RIEMANN(SOLUTION_INT_R, SOLUTION_EXT_R, NFLUX_Y_U, 1.0D0, 1.0D0, (/0.0D0, 1.0D0/))
