...
LOGICAL, ALLOCATABLE, DIMENSION(:) :: FLAG_MPI_B_X   !< MPI BOUNDARY FLAG(X DIRECTION). .TRUE. == ON THE MPI_BOUNDARY
LOGICAL, ALLOCATABLE, DIMENSION(:) :: FLAG_MPI_B_Y   !< MPI BOUNDARY FLAG(Y DIRECTION). .TRUE. == ON THE MPI_BOUNDARY
