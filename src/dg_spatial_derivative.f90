...
SUBROUTINE DG_SPATIAL_DERIVATIVE(N_TH, FLUX_LEFT, FLUX_RIGHT, &
    ...
    DOUBLE PRECISION :: FLUX_LEFT(NUM_OF_EQUATION)  !< NUMERICAL FLUX AT THE LEFT BOUNDARY
    DOUBLE PRECISION :: FLUX_RIGHT(NUM_OF_EQUATION) !< NUMERICAL FLUX AT THE RIGHT BOUNDARY
